...
abstract class AbstractSeeder implements LoggerAwareInterface, SeederInterface
{
     ...
     */
    protected function loadResourcesBeforeChunkMapping(LazyCollection $lazyCollection): void
    {
        //
    }
     ...
     */
    protected function unloadResourcesAfterChunkMapping(LazyCollection $lazyCollection): void
    {
        //
    }
     ...
     * Map records for seeding.
     */
    private function mapRecords(LazyCollection $lazyCollection): iterable
    {
        foreach ($lazyCollection as $record) {
